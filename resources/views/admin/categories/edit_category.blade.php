  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
        <a href="#"> Category</a> <a href="#" class="current">Edit Category</a> </div>
      <h1>Categories</h1>
    </div>
                  ...
                  <div class="controls">
                    <select name="parent_id" style="width:220px;">
                      ...
                      @foreach ($levels as $value)
                        <option value="{{ $value->id }}" @if ($value->id == $categoryDetails->parent_id)selected @endif> {{ $value->name }} </option>
                      @endforeach
                    </select>
                  </div>
                </div>
